...
export const api = {
  ...
  // 客服聊天
  sendChat(userId, productId, message){
    return http.post(`/customer-service/chat`, { user_id: userId, product_id: productId, message })
  },
  ...
  sendChatWithUpload(userId, productId, message, { images = [], files = [], audios = [] } = {}){
    ...
    return http.post(`/customer-service/chat/upload`, fd)
  },
  getUser(userId) {
